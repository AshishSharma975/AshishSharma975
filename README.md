<!-- Portfolio-Style README with Sidebar + Banner + Animated Header -->
...
<div style="display:flex; gap:28px; align-items:flex-start;">
  ...
  <div style="width:300px; min-width:260px; border-radius:14px; padding:18px; background:#0b0c10; color:#dfe9f7; box-shadow:0 12px 35px rgba(0,0,0,0.55)">
    ...
    <p style="margin:0 0 14px; color:#9fcbe8; font-size:13px">
      Frontend Developer • 3D Web (Three.js / WebGL) • GSAP
    </p>

    <div style="font-size:13px; line-height:1.6; color:#cfdff0;">
      <strong>Contact</strong>
      <div style="margin:6px 0 12px;">
        📧 <a href="mailto:ashish8389sharma@gmail.com">ashish8389sharma@gmail.com</a><br/>
        📱 +91 88277 18774<br/>
        🔗 <a href="https://www.linkedin.com/in/ashish8822/">linkedin.com/in/ashish8822</a><br/>
        🖥️ <a href="https://github.com/AshishSharma975">github.com/AshishSharma975</a>
      </div>
      ...
      <strong>Tools</strong>
      <div style="margin-top:10px; color:#b9cde6;">
  ...
  <div style="flex:1;">
    ...
    <section style="margin-top:18px; background:#07101a; padding:16px; border-radius:12px; box-shadow:0 12px 30px rgba(0,0,0,0.55);">
      ...
      <div style="display:flex; gap:14px; flex-wrap:wrap; align-items:center;">
        ...
        <div style="flex:1; min-width:260px; color:#cfe8ff;">
          <p>
            Drag, sculpt and blend procedural blobs — real-time GLSL deformation, noise motion and smooth UI.
          </p>

          <p><strong>🔗 Live Demo:</strong> https://lnkd.in/dBphVcUA</p>
          <p><strong>📦 GitHub Code:</strong> https://lnkd.in/dq_c6ENX</p>

          <ul>
            <li>Three.js + GLSL shaders</li>
            <li>Noise-driven deformation</li>
    ...
    <section style="margin-top:18px; background:#07101a; padding:16px; border-radius:12px; box-shadow:0 12px 30px rgba(0,0,0,0.55);">
      ...
      <div style="display:flex; gap:14px; flex-wrap:wrap; align-items:center;">
        ...
        <div style="flex:1; min-width:260px; color:#cfe8ff;">
          <p>
            360° product rotation, color picker, hotspot highlights, HDR lighting and music toggle.
          </p>

          <p><strong>🔗 Live Demo:</strong> https://jersy.vercel.app/</p>
          <p><strong>📦 GitHub Code:</strong> https://lnkd.in/ddQSi8Ac</p>

          <ul>
            <li>Color variants</li>
            <li>Hotspot-based UX</li>
            <li>Studio-like lighting</li>
          </ul>
        </div>
      </div>
    </section>
